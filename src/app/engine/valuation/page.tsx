    ...
    <div className="min-h-screen w-full bg-black text-white pt-32 md:pt-36">
      <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20 py-12 md:py-16">
        ...
        {results && (
          <section>
            <Card className="bg-white/[0.02] border-white/[0.08] p-6 md:p-8">
              <h2 className="text-xl font-light mb-8 text-white">Results</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="space-y-2">
                  <p className="text-sm text-white/50">Breakeven Point</p>
                  <p className="text-3xl font-light text-white">
                    {formatCurrency(results.breakevenTTT)}
                  </p>
                  <p className="text-xs text-white/40 mt-1">
                    Total winnings where both scenarios equal
                  </p>
                </div>
                
                <div className="space-y-2">
                  <p className="text-sm text-white/50">Owner Return at Breakeven</p>
                  <p className="text-3xl font-light text-[#d4a964]">
                    {formatCurrency(results.ownerReturnLease)}
                  </p>
                  <p className="text-xs text-white/40 mt-1">
                    Same for both lease and no-lease scenarios
                  </p>
                </div>
              </div>
              ...
              <div className="border-t border-white/10 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    <div className="w-1 h-full bg-[#d4a964] rounded-full mt-1"></div>
                    <div>
                      <p className="text-sm font-medium text-white mb-1">
                        Favorable Below Breakeven
                      </p>
                      <p className="text-sm text-white/60">
                        Leasing outperforms full ownership for winnings under {formatCurrency(results.breakevenTTT)}, providing fixed income while transferring performance risk.
                      </p>
                    </div>
                  </div>
