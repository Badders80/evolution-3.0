    ...
    <div className={`space-y-6 ${className}`}>
      {items.map((item, index) => (
        <div key={item.question} className="flex gap-6">
          <div className="flex h-10 w-10 items-center justify-center rounded-full border border-brand-gold/60 text-xs font-semibold uppercase tracking-[0.3em] text-brand-gold">
